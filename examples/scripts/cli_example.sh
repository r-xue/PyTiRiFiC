...
gmake_cli ../inpfile/bx610_band6_uv_mc.inp --debug --fit        #   model fitting
gmake_cli ../inpfile/bx610_band6_uv_mc.inp --debug --analyze    #   analyze / model exporting/imaging
gmake_cli ../inpfile/bx610_band6_uv_mc.inp --debug --plot       #   diagnostic plots
