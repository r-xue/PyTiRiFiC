...
def gmake_plots_mom0xy(fn,linechan=None):
    ...
    fn_basename=os.path.basename(fn)
    ax1.set_title(fn_basename)
    ax1.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
    ax1.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
    ...
    ax2.set_title('Model')
    ax2.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
    ax2.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
    ...
    ax3.set_title('Residual')
    ax3.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
    ax3.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
    ...
    if  isline==True:
        ...
        ax4.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax4.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")           
        ...
        ax6.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax6.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
        ...
        ax10.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax10.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
        ...
        ax11.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax11.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")           
        ...
        ax12.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax12.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
        ...
        ax13.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax13.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")
        ...
        ax14.plot([cxy[0]+10,cxy[0]+21],[cxy[1],cxy[1]],color="yellow")
        ax14.plot([cxy[0],cxy[0]],[cxy[1]+10,cxy[1]+21],color="yellow")                              
