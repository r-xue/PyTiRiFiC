...
setuptools.setup(name='GMaKE',
                 ...
                 install_requires=[
                    ...
                    'scipy','reproject','fitsio','fits-tools','yt','memory-profiler',
                    'python-casacore>=3.1.1','galpy',
                    'reikna','tqdm',
                    'asteval>=0.9.14','numexpr>=2.7.0',
                    'pvextractor>=0.2.dev327','spectral-cube>=0.4.5.dev','radio-beam>=0.3','reproject>=0.6.dev',
                    'emcee>=3.0rc2','corner>=2.0','lmfit','mkl-fft',
                    'pyyaml','hickle',
                    'casa-proc',
                    ],
                 extras_require={},
